...
namespace VnApptech_GYM_Soft.DanhMuc
{
    public partial class BLL_DanhMuc
    {
        ...
        {
            return data.GetDataTable("Psp_CaLamViec_selectall", CommandType.StoredProcedure, ref err);
        }
        /// <summary>
        /// Ngày tạo: 29-08-2016
        /// Người tạo: Nguyễn Minh Phúc
        ...
        {
            return data.MyExcuteNonQuery("PSP_CaLamViec_Insert", CommandType.StoredProcedure,
        ...
        {
            return data.MyExcuteNonQuery("PSP_CaLamViec_Delete_MaCaLamViec", CommandType.StoredProcedure,
        ...
        {
            return data.GetDataTable("PSP_CaLamViec_Select_MaCaLamViec", CommandType.StoredProcedure, ref err,
                                    new SqlParameter("@MaCaLamViec", maCaLamViec));
        }
       /// <summary>
        /// Ngày tạo: 29-08-2016
       ...
       /// <returns>Trả về true nếu sửa thành công, ngược lại trả về false</returns>
        ...
        {
            return data.MyExcuteNonQuery("PSP_CaLamViec_Update_MaCaLamViec", CommandType.StoredProcedure,
                                    new SqlParameter("@MaCaLamViec", maCaLamViec),
                                    new SqlParameter("@GioBatDau", gioBatDau),
                                    new SqlParameter("@GioKetThuc", gioKetThuc),
                                    new SqlParameter("@GhiChu", ghiChu),
        ...
        {
            return data.GetDataTable("PSP_LoaiKhachHang_SelectAll", CommandType.StoredProcedure, ref err);
        }

        public bool ThemLoaiKhachHang(string tenLoaiKhach, string ghiChu, int tinhTrang)
        {
            return data.MyExcuteNonQuery("PSP_LoaiKhachHang_Insert", CommandType.StoredProcedure,
        ...
        {
            return data.MyExcuteNonQuery("PSP_LoaiKhachHang_Delete_MaLoaiKhach", CommandType.StoredProcedure,
        ...
        {
            return data.GetDataTable("PSP_LoaiKhachHang_Select_MaLoaiKhach", CommandType.StoredProcedure, ref err,
                                    new SqlParameter("@MaLoaiKhach", maLoaiKhach));
        }
        public bool SuaThongTinLoaiKhachHangTheoMaLoaiKhach(int maLoaiKhach, string tenLoaiKhach, string ghiChu, int tinhTrang)
        {
            return data.MyExcuteNonQuery("PSP_LoaiKhachHang_Update_MaLoaiKhach", CommandType.StoredProcedure,
                                    new SqlParameter("@MaLoaiKhach", maLoaiKhach),
                                    new SqlParameter("@TenLoaiKhach", tenLoaiKhach),
                                    new SqlParameter("@GhiChu", ghiChu),
                                    new SqlParameter("@TinhTrang", tinhTrang));
        ...
        {
            return data.GetDataTable("PSP_NhanVien_SelectAll", CommandType.StoredProcedure, ref err);
        }
        ...
        {
            return data.MyExcuteNonQuery("PSP_NhanVien_Insert", CommandType.StoredProcedure,
        ...
        {
            return data.MyExcuteNonQuery("PSP_NhanVien_Delete_MaNhanVien", CommandType.StoredProcedure,
                                    new SqlParameter("@MaNhanVien", maNhanVien));
        }
        public DataTable LayThongTinNhanVienTheoMaNhanVien(int maNhanVien, ref string err)
        {
            return data.GetDataTable("PSP_NhanVien_Select_MaNhanVien", CommandType.StoredProcedure, ref err,
                                    new SqlParameter("@MaNhanVien", maNhanVien));
        }
        ...
        {
            return data.MyExcuteNonQuery("PSP_NhanVien_Update_MaNhanVien", CommandType.StoredProcedure,
                                    new SqlParameter("@MaNhanVien", maNhanVien),
                                    new SqlParameter("@TenNhanVien", tenNhanVien),
                                    new SqlParameter("@Phai", phai),
                                    new SqlParameter("@NamSinh", namSinh),
        ...
        {
            return data.GetDataTable("PSP_TaiKhoan_SelectAll", CommandType.StoredProcedure, ref err);
        }

        public bool ThemTaiKhoan(string tenTaiKhoan, int TinhTrang)
        {
            return data.MyExcuteNonQuery("PSP_TaiKhoan_Insert", CommandType.StoredProcedure,
                                    new SqlParameter("@TenTaiKhoan", tenTaiKhoan),
                                    new SqlParameter("@TinhTrang", TinhTrang));
        }
        public bool XoaTaiKhoanTheoMaTaiKhoan(int maTaiKhoan)
        {
            return data.MyExcuteNonQuery("PSP_TaiKhoan_Delete_MaTaiKhoan", CommandType.StoredProcedure,
                                    new SqlParameter("@MaTaiKhoan", maTaiKhoan));
        }
        public DataTable LayThongTinTaiKhoanTheoMaTaiKhoan(int maTaiKhoan, ref string err)
        {
            return data.GetDataTable("PSP_TaiKhoan_Select_MaTaiKhoan", CommandType.StoredProcedure, ref err,
                                    new SqlParameter("@MaTaiKhoan", maTaiKhoan));
        }
        public bool SuaThongTinTaiKhoanTheoMaTaiKhoan(int maTaiKhoan, string tenTaiKhoan, int tinhTrang)
        {
            return data.MyExcuteNonQuery("PSP_TaiKhoan_Update_MaTaiKhoan", CommandType.StoredProcedure,
                                    new SqlParameter("@MaTaiKhoan", maTaiKhoan),
                                    new SqlParameter("@TenTaiKhoan", tenTaiKhoan),
                                    new SqlParameter("@TinhTrang", tinhTrang));
        }
